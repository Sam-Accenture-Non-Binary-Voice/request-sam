...
The central assets used in this project are described below and available in a private GitHub repository. To request access to this repository, email [nonbinary_voice@accenture.com](mailto:nonbinary_voice@accenture.com?subject=[GitHub]) with a brief description of yourself (name, organization) and of the reason behind your interest.
### Repository Contents
